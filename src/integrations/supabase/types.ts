    ...
    Tables: {
      ...
      contract_adjustments: {
        Row: {
          ...
          adjustment_index_value: number | null
          adjustment_type: string | null
          becomes_new_base: boolean
      ...
      contracts: {
        Row: {
          ...
          canon_kg_cuotas: number | null
          canon_kg_inicio_anual: number | null
          canon_kg_per_ha: number | null
          ...
          initial_rent: number
          inmag_index_value: number | null
          interest_rate: number | null
          is_active: boolean
          jurisdiction_region: string | null
          next_adjustment_date: string | null
          num_cuotas: number | null
          payment_currency_unit: string | null
          pdf_url: string | null
